...
function M.setup(opts)
	...
	if opts.keymaps ~= false then
		...
		vim.keymap.set(
			"n",
			opts.next_function_call or "]f",
			M.next_function_call,
			vim.tbl_extend("force", keymap_opts, { desc = "Next function call" })
		)
		vim.keymap.set(
			"n",
			opts.prev_function_call or "[f",
			M.prev_function_call,
			vim.tbl_extend("force", keymap_opts, { desc = "Previous function call" })
		)
		vim.keymap.set(
			"n",
